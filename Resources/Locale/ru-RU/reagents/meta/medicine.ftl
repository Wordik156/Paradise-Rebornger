...
reagent-name-arcryox = акрилокс
reagent-desc-arcryox = Вызывающе синий криогенный химикат, способный залечивать тяжелейшие раны даже у мертвых. Однако он с трудом стабилизирует состояние пациентов.
...
reagent-desc-warfarin = Часто используется как антикоагулянт. Препятствует свертыванию крови. При передозировке может вызвать внутреннее кровотечение.
