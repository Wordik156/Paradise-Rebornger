...
ent-XenoborgMaterialBag = квадратное хранилище киборгов
    .desc = Подделка блюспейс-сумки. Может засасывать определенные материалы, но непригодна для использования гуманоидами из-за вредных излучений.
